  ...
  return (
    <section id="products" className="py-28 px-6 relative">
      ...
      <div
        ...
        style={{
          background: "radial-gradient(ellipse 80% 40% at 50% 50%, rgba(201,168,76,0.04) 0%, transparent 70%)",
        }}
      />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between mb-16 gap-6">
          ...
          <p className="text-[#6B6B72] max-w-sm text-base font-light leading-relaxed md:text-right">
            A growing portfolio of technology brands solving real everyday challenges for individuals, businesses, and institutions.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {products.map((p, i) => (
            <a
              ...
              className={`card-hover group relative rounded-2xl border ${p.border} bg-gradient-to-br ${p.color} bg-[#111113] p-7 flex flex-col gap-4 ${
            ...
            >
              ...
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-display font-700 text-white text-base">{p.name}</h3>
                    <span className="text-xs text-[#6B6B72] font-medium">{p.tag}</span>
                  </div>
                </div>
              </div>

              {/* Desc */}
              <p className="text-[#6B6B72] text-sm leading-relaxed flex-1">{p.desc}</p>
